...
import content from "@/content/CHARTER.en.md";

export const metadata: Metadata = {
  title: "AAES Charter — Charter & Bylaws",
  description:
    "Charter & Bylaws of the Autonomous Agent Ecosystem of Science (AAES). English translation.",
};

export default function CharterEnPage() {
  return (
